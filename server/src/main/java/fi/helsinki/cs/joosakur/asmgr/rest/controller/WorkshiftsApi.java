...
public interface WorkshiftsApi {
    ...
    ResponseEntity<List<WorkshiftGet>> listWorkshifts(@NotNull @ApiParam(value = "from date", required = true) @RequestParam(value = "from") LocalDate from,
                                                      @NotNull @ApiParam(value = "to date", required = true) @RequestParam(value = "to") LocalDate to,
                                                      @ApiParam(value = "id of the employer") @RequestParam(value = "employerId", required = false) UUID employerId,
                                                      @ApiParam(value = "id of the assistant") @RequestParam(value = "assistantId", required = false) UUID assistantId);
