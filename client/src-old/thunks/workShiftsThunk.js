...
import {formErrorFromApiError, generalErrorFromApiError} from "../../src/utils/errorUtils"
import {
...
} from "../../src/actions/api/workShiftActions"
...
export function getWorkShifts(fromDate, toDate, assistantId) {
  return function (dispatch, getState) {
    ...
    return axios.get(API.origin+API.workShifts, {
      ...
      params: {'from': fromDate, 'to': toDate, assistantId: workShiftId}
    })
      .then((response) => {
...
export function sendWorkShiftForm(form) {
  ...
  let body = {
    workShiftId: form.assistant === "Unassigned" ? null : form.assistant,
